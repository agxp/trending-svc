...
func main() {
	...
	zapLogger := logger.With(zap.String("service", "trending-svc"))
	...
	repo := &TrendingRepository{s3, pg, tracer, vh}
	...
	// Register handler
	pb.RegisterTrendingHandler(srv.Server(), &service{repo, tracer, zapLogger})
